...
-(void)dismissSoftModal {
    ...
    UIButton* dismiss = self.view.superview.subviews[thisViewIndex-1];
...
-(CGSize)sizeInSoftModal {
    CGSize windowSize = [UIApplication sharedApplication].windows.firstObject.rootViewController.view.bounds.size;
    return CGSizeMake(round(windowSize.width * 0.7), round(windowSize.height * 0.7));
}
